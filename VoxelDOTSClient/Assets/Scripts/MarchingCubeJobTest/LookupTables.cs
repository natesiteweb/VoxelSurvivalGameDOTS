...
{
    public static readonly int3[] CornerIndex = new[]
    {
            new int3(0,0,0),
            new int3(1,0,0),
            new int3(0,0,1),
    ...
    public static readonly int3[] CornerIndexTransitionCell = new[]
    {
        
        //bottom
        new int3(0,2,0), new int3(1,2,0), new int3(2,2,0), // High-res lower row
        new int3(0,2,1), new int3(1,2,1), new int3(2,2,1), // High-res middle row
        new int3(0,2,2), new int3(1,2,2), new int3(2,2,2), // High-res upper row
        new int3(0,0,0), new int3(2,0,0), // Low-res lower row
        new int3(0,0,2), new int3(2,0,2),  // Low-res upper row
        //top
        new int3(2,0,0), new int3(1,0,0), new int3(0,0,0), // High-res lower row
        new int3(2,0,1), new int3(1,0,1), new int3(0,0,1), // High-res middle row
        new int3(2,0,2), new int3(1,0,2), new int3(0,0,2), // High-res upper row
        new int3(2,2,0), new int3(0,2,0), // Low-res lower row
        new int3(2,2,2), new int3(0,2,2),  // Low-res upper row
        //left
        new int3(2,0,0), new int3(2,0,1), new int3(2,0,2), // High-res lower row
        new int3(2,1,0), new int3(2,1,1), new int3(2,1,2), // High-res middle row
        new int3(2,2,0), new int3(2,2,1), new int3(2,2,2), // High-res upper row
        new int3(0,0,0), new int3(0,0,2), // Low-res lower row
        new int3(0,2,0), new int3(0,2,2),  // Low-res upper row
        //right
        new int3(0,0,2), new int3(0,0,1), new int3(0,0,0), // High-res lower row
        new int3(0,1,2), new int3(0,1,1), new int3(0,1,0), // High-res middle row
        new int3(0,2,2), new int3(0,2,1), new int3(0,2,0), // High-res upper row
        new int3(2,0,2), new int3(2,0,0), // Low-res lower row
        new int3(2,2,2), new int3(2,2,0),  // Low-res upper row
        //back
        new int3(2,0,2), new int3(1,0,2), new int3(0,0,2), // High-res lower row
        new int3(2,1,2), new int3(1,1,2), new int3(0,1,2), // High-res middle row
        new int3(2,2,2), new int3(1,2,2), new int3(0,2,2), // High-res upper row
        new int3(2,0,0), new int3(0,0,0), // Low-res lower row
        new int3(2,2,0), new int3(0,2,0), // Low-res upper row
        //front
        new int3(0,0,0), new int3(1,0,0), new int3(2,0,0), // High-res lower row
        new int3(0,1,0), new int3(1,1,0), new int3(2,1,0), // High-res middle row
        new int3(0,2,0), new int3(1,2,0), new int3(2,2,0), // High-res upper row
        new int3(0,0,2), new int3(2,0,2), // Low-res lower row
        new int3(0,2,2), new int3(2,2,2),  // Low-res upper row
    };
